...
-- Dumping database structure for amazonas
CREATE DATABASE IF NOT EXISTS `amazonas` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `amazonas`;


-- Dumping structure for table amazonas.calificacion
CREATE TABLE IF NOT EXISTS `calificacion` (
  ...
  CONSTRAINT `FK1_DETALLE_CALIFICACION` FOREIGN KEY (`fk_detalle_pedido`) REFERENCES `detalle_pedido` (`id_detalle_pedido`),
  CONSTRAINT `FK2_USUARIO_CALIFICACION` FOREIGN KEY (`fk_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.calificacion: ~0 rows (approximately)
/*!40000 ALTER TABLE `calificacion` DISABLE KEYS */;
/*!40000 ALTER TABLE `calificacion` ENABLE KEYS */;


-- Dumping structure for table amazonas.categoria
...
-- Dumping data for table amazonas.categoria: ~24 rows (approximately)
...
-- Dumping structure for table amazonas.destino
CREATE TABLE IF NOT EXISTS `destino` (
  ...
  CONSTRAINT `FK1_LUGAR_DESTINO` FOREIGN KEY (`fk_lugar`) REFERENCES `lugar` (`id_lugar`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.destino: ~0 rows (approximately)
/*!40000 ALTER TABLE `destino` DISABLE KEYS */;
/*!40000 ALTER TABLE `destino` ENABLE KEYS */;


-- Dumping structure for table amazonas.detalle_pedido
CREATE TABLE IF NOT EXISTS `detalle_pedido` (
  ...
  CONSTRAINT `FK1_PEDIDO_DETALLE` FOREIGN KEY (`fk_pedido`) REFERENCES `pedido` (`id_pedido`),
  CONSTRAINT `FK2_PRODUCTO_DETALLEP` FOREIGN KEY (`fk_producto`) REFERENCES `producto` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.detalle_pedido: ~0 rows (approximately)
/*!40000 ALTER TABLE `detalle_pedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_pedido` ENABLE KEYS */;


-- Dumping structure for table amazonas.detalle_producto
CREATE TABLE IF NOT EXISTS `detalle_producto` (
  ...
  CONSTRAINT `FK1_PRODUCTO_DETALLE` FOREIGN KEY (`fk_producto`) REFERENCES `producto` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.detalle_producto: ~0 rows (approximately)
/*!40000 ALTER TABLE `detalle_producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalle_producto` ENABLE KEYS */;


-- Dumping structure for table amazonas.forma_de_pago
CREATE TABLE IF NOT EXISTS `forma_de_pago` (
  ...
  CONSTRAINT `FK1_USUARIO_FORMAPAGO` FOREIGN KEY (`fk_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.forma_de_pago: ~0 rows (approximately)
/*!40000 ALTER TABLE `forma_de_pago` DISABLE KEYS */;
/*!40000 ALTER TABLE `forma_de_pago` ENABLE KEYS */;


-- Dumping structure for table amazonas.lugar
CREATE TABLE IF NOT EXISTS `lugar` (
  ...
  CONSTRAINT `FK1_LUGAR_LUGAR` FOREIGN KEY (`fk_lugar`) REFERENCES `lugar` (`id_lugar`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.lugar: ~86 rows (approximately)
...
-- Dumping structure for table amazonas.multimedia
CREATE TABLE IF NOT EXISTS `multimedia` (
  ...
  CONSTRAINT `FK1_PRODUCTO_MULTIMEDIA` FOREIGN KEY (`fk_producto`) REFERENCES `producto` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.multimedia: ~0 rows (approximately)
/*!40000 ALTER TABLE `multimedia` DISABLE KEYS */;
/*!40000 ALTER TABLE `multimedia` ENABLE KEYS */;


-- Dumping structure for table amazonas.pedido
CREATE TABLE IF NOT EXISTS `pedido` (
  ...
  CONSTRAINT `FK3_TRANSPORTE_PEDIDO` FOREIGN KEY (`fk_transporte`) REFERENCES `transporte` (`id_transporte`),
  CONSTRAINT `FK1_FORMAPAGO_PEDIDO` FOREIGN KEY (`fk_formadepago`) REFERENCES `forma_de_pago` (`id_formadepago`),
  CONSTRAINT `FK2_DESTINO_PEDIDO` FOREIGN KEY (`fk_destino`) REFERENCES `destino` (`id_destino`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.pedido: ~0 rows (approximately)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido` ENABLE KEYS */;


-- Dumping structure for table amazonas.producto
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  CONSTRAINT `FK1_CATEGORIA_PRODUCTO` FOREIGN KEY (`fk_categoria`) REFERENCES `categoria` (`id_categoria`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.producto: ~1 rows (approximately)
...
-- Dumping structure for table amazonas.telefono
CREATE TABLE IF NOT EXISTS `telefono` (
  ...
  CONSTRAINT `FK1_USUARIO_TELEFONO` FOREIGN KEY (`fk_usuario`) REFERENCES `usuario` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.telefono: ~9 rows (approximately)
...
-- Dumping structure for table amazonas.transporte
...
-- Dumping data for table amazonas.transporte: ~0 rows (approximately)
/*!40000 ALTER TABLE `transporte` DISABLE KEYS */;
/*!40000 ALTER TABLE `transporte` ENABLE KEYS */;


-- Dumping structure for table amazonas.usuario
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `estado_usuario` set('activo','inactivo') NOT NULL,
  `zona_postal` varchar(20) NOT NULL,
  `fk_lugar` smallint(5) NOT NULL,
  PRIMARY KEY (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Dumping data for table amazonas.usuario: ~5 rows (approximately)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`id_usuario`, `nombre`, `apellido`, `correo`, `fecha_nac`, `fecha_registro`, `direccion`, `estado_usuario`, `zona_postal`, `fk_lugar`) VALUES
